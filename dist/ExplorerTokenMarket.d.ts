...
export declare class ExplorerTokenMarket implements ITokenMarket {
    ...
    getTokenBalanceByAddress(address: string, tokenSwapValues?: ITokenRate[]): Promise<IAddressTokenAmounts | undefined>;
    getTokenInfoById(tokenId: string): Promise<ITokenInfo>;
